...
Při registraci zkontroluj, že karta ve Studiu načítá verzi `1.3.6` z živého `studio-manifest.json`. Přístupová politika se nemění: aplikace nadále pracuje s potenciálně citlivými školními daty a má zůstat za centrální ochranou AI Studia.
