# Hodnotitel maturitních slohů 1.5.22

**Aktuální verze:** 1.5.22  
...
## Základ 1.5.5 zachovaný ve verzi 1.5.22
...
Verze 1.5.22 už skutečný obsah ostré maturitní sady **neobsahuje** ve veřejném zdroji ani v distribuovaném `app.js`. Učitel načítá budoucí důvěrnou sadu explicitním JSON importem pouze pro aktuální browser relaci; persistentní task/state/Batch snapshoty její zadání redigují.
...
### Důvěrná ostrá zadání
Ostrá maturitní zadání nejsou součástí veřejného zdroje ani distribuovaného JavaScriptu. Učitel je načítá přes JSON import; úplná ostrá sada zůstává pouze v sessionStorage aktuální relace a po jejím ukončení se znovu neobnoví.
