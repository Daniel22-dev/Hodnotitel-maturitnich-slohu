...
const pkg=JSON.parse(readFileSync(new URL('../package.json',import.meta.url),'utf8'));const reg=JSON.parse(readFileSync(new URL('../src/studio-integration/essay-evaluator-registration.json',import.meta.url),'utf8').replaceAll('__APP_VERSION__',pkg.version));
