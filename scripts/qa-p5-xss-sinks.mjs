...
const report={schema:'ghrab-p5-xss-sink-audit-v1',appId:baseline.appId,counts,baseline:baseline.counts,csp,evidence,limitations:['This is a regression inventory, not proof that every HTML sink is safe.','Remaining HTML sinks require continued review; executable inline JavaScript is forbidden by the deployment CSP.'],failures,status:failures.length?'failed':'passed'};
