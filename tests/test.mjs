...
check(contains(access,'IMPORT_TIMEOUT_MS')&&contains(access,'CHECK_TIMEOUT_MS')&&contains(access,'Nouzový offline režim'),'brána má timeout a viditelné offline upozornění');
