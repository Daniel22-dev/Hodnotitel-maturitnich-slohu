# Hodnotitel maturitních slohů 1.5.27

**Aktuální verze:** 1.5.27  
...
## Základ 1.5.5 zachovaný ve verzi 1.5.27
...
Verze 1.5.27 už skutečný obsah ostré maturitní sady **neobsahuje** ve veřejném zdroji ani v distribuovaném `app.js`. Učitel načítá budoucí důvěrnou sadu explicitním JSON importem pouze pro aktuální browser relaci; persistentní task/state/Batch snapshoty její zadání redigují.
