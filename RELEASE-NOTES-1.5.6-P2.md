# Hodnotitel maturitních slohů 1.5.6 — etapa P2
...
- Vratná migrace aplikačních dat do prefixu `ghrab.essay-evaluator.*`; záloha se vytváří před odstraněním starých klíčů.
...
- PWA cache `ghrab-essay-evaluator-v${APP_VERSION}` a aktualizační zpráva `GHRAB_SKIP_WAITING`.
